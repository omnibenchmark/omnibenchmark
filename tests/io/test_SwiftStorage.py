            ...
            return [
                {
                    ...
                    "hash": "hash",
                    "last_modified": "2021-07-08T14:33:00.000000",
                    "bytes": 1,
                    "name": "test_container",
...
def test__test_connect(monkeypatch):
    ...
    ss = SwiftStorage(
        auth_options={"preauthurl": "https://", "preauthtoken": "token"},
        benchmark="test",
    )
...
def test_init_public():
    ss = SwiftStorage(
        auth_options={
            "preauthurl": "https://cloud.s3it.uzh.ch:8080/v1/AUTH_fed6cdab6446481597fad8aa67751bd5",
            "retries": 3,
            "starting_backoff": 1,
            "max_backoff": 8,
        },
