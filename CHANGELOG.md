...
- refactor(cli)!: simplify `ob run` command - benchmark file is now a positional argument (`ob run benchmark.yaml` instead of `ob run benchmark -b benchmark.yaml`)
- refactor(cli)!: remove `ob run module` command
