...
def resolve_metric_collectors(
    ...
    Args:
        ...
        unpinned: If True, allow unpinned branch refs on remote repos
...
def _resolve_collector_module(
    ...
    if quiet:
        ...
        old_git_level = git_logger.level
        old_resolver_level = resolver_logger.level
    ...
    with warnings.catch_warnings(record=True):
        ...
        try:
            ...
            if quiet:
                ...
                git_logger.setLevel(old_git_level)
                resolver_logger.setLevel(old_resolver_level)
