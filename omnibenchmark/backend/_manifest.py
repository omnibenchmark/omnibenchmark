...
def write_run_manifest(
    ...
    try:
        ...
        # Best-effort system introspection: if we cannot determine the CPU count,
        # silently leave cpu_count as None rather than failing the run.
        pass
    ...
    try:
        ...
        # Best-effort CPU model detection; on failure, leave cpu_model as None.
        print(f"Warning: failed to detect CPU model: {exc!r}", file=sys.stderr)
    ...
    try:
        ...
        # Best-effort memory detection; on any error, leave memory_total_mb as None.
        pass
            ...
            for line in result.stdout.strip().splitlines():
                ...
                if len(parts) >= 3:
                    try:
                        ...
                        # Ignore malformed memory value; memory_total_mb is optional.
                        pass
                gpu_devices.append(entry)
    except Exception:
        # Best-effort GPU detection via nvidia-smi; on any error, leave
        # gpu_devices as None.
        pass
